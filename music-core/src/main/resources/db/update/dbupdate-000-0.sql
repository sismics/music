...
create cached table T_TRACK ( TRK_ID_C varchar(36) not null, TRK_IDALBUM_C varchar(36) not null, TRK_IDARTIST_C varchar(36) not null, TRK_FILENAME_C varchar(2000) not null, TRK_TITLE_C varchar(2000) not null, TRK_YEAR_N integer, TRK_GENRE_C varchar(100), TRK_LENGTH_N integer not null, TRK_BITRATE_N integer not null, TRK_ORDER_N integer, TRK_VBR_B bit not null, TRK_FORMAT_C varchar(50) not null, TRK_CREATEDATE_D datetime not null, TRK_DELETEDATE_D datetime, primary key (TRK_ID_C) );
