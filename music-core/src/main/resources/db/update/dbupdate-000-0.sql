...
create cached table T_ARTIST ( ART_ID_C varchar(36) not null, ART_NAME_C char(10) not null, ART_CREATEDATE_D datetime not null, ART_DELETEDATE_D datetime, primary key (ART_ID_C) );
...
create memory table T_DIRECTORY ( DIR_ID_C varchar(36) not null, DIR_NAME_C varchar(100) not null, DIR_LOCATION_C varchar(1000), DIR_CREATEDATE_D datetime not null, DIR_DISABLEDATE_D datetime, DIR_DELETEDATE_D datetime, primary key (DIR_ID_C) );
...
create cached table T_PLAYLIST_TRACK ( PLT_ID_C varchar(36) not null, PLT_IDUSER_C varchar(36) not null, PLT_IDTRACK_C varchar(36) not null, PLT_ORDER_N int not null, primary key (PLT_ID_C) );
...
create cached table T_TRACK ( TRK_ID_C varchar(36) not null, TRK_IDALBUM_C varchar(36) not null, TRK_IDARTIST_C varchar(36) not null, TRK_FILE_C varchar(2000) not null, TRK_NAME_C varchar(2000) not null, TRK_YEAR_N integer, TRK_LENGTH_N integer not null, TRK_BITRATE_N integer not null, TRK_VBR_B bit not null, TRK_FORMAT_C varchar(10) not null, TRK_CREATEDATE_D datetime not null, TRK_DELETEDATE_D datetime, primary key (TRK_ID_C) );
create memory table T_TRANSCODER ( TRN_ID_C varchar(36) not null, TRN_NAME_C varchar(100) not null, TRN_SOURCE_C varchar(1000) not null, TRN_DESTINATION_C varchar(100) not null, TRN_STEP1_C varchar(1000) not null, TRN_STEP2_C varchar(1000) default '0', TRN_CREATEDATE_D datetime not null, TRN_DELETEDATE_D datetime, primary key (TRN_ID_C) );
create memory table T_USER ( USE_ID_C varchar(36) not null, USE_IDLOCALE_C varchar(10) not null, USE_IDROLE_C varchar(36) not null, USE_USERNAME_C varchar(50) not null, USE_PASSWORD_C varchar(60) not null, USE_EMAIL_C varchar(100) not null, USE_THEME_C varchar(100) not null, USE_MAXBITRATE_N integer default 0, USE_LASTFMLOGIN_C varchar(100) default '0', USE_LASTFMPASSWORD_C varchar(100) default '0', USE_LASTFMACTIVE_B bit default 0 not null, USE_FIRSTCONNECTION_B bit default 0 not null, USE_CREATEDATE_D datetime not null, USE_DELETEDATE_D datetime, primary key (USE_ID_C) );
