create cached table T_ALBUM ( ALB_ID_C varchar(36) not null, ALB_IDDIRECTORY_C varchar(36) not null, ALB_IDARTIST_C varchar(36) not null, ALB_NAME_C varchar(1000) not null, ALB_ALBUMART_C varchar(36), ALB_SCORE_N int not null, ALB_UPDATEDATE_D datetime not null,  ALB_CREATEDATE_D datetime not null, ALB_DELETEDATE_D datetime, primary key (ALB_ID_C) );
