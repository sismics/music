...
public class IndexingService extends AbstractScheduledService {
    ...
    protected void shutDown() {
        if (directoryReader != null) {
            try {
                ...
                log.error("Error closing the index music", e);
            }
        }
        if (directory != null) {
            try {
    ...
    /**
     * Returns a valid directory music.
     * Take care of reopening the music if the index has changed
    ...
    public DirectoryReader getDirectoryReader() {
        if (directoryReader == null) {
            ...
            try {
                ...
                log.error("Error creating the directory music", e);
            }
        } else {
            try {
                ...
                log.error("Error while reopening the directory music", e);
            }
        }
