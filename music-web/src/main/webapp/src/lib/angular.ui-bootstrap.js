...
dialogModule.factory('$dialog', ['$rootScope', '$modal', '$sce', function($rootScope, $modal, $sce) {
  ...
  return {
    ...
    messageBox: function(title, message, buttons, resultFn) {
      var scope = angular.extend($rootScope.$new(false), { title: title, message: $sce.trustAsHtml(message), buttons: buttons });
